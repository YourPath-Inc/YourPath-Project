...
INSERT INTO `yourpath`.`punto` (`user_id`, `titulo`, `init_date`, `end_date`, `descripcion`, `state`, `location`) VALUES 
	-- Puntos Roman
	('1', 'Ciclo Formativo de Grado Medio, SMX', '2018', '2020', 'Creacion de paginas con tecnologia Wordpress, Html, Css, Mantenimiento de Sistemas Windows y Redes', 'DONE', 'Salesians Sarrià'),
    ...
    ('1', 'CFG Desarrollo de aplicaciones multiplataforma', '2020', '2022', 'Desarrollo de aplicaciones en lenguaje Java, SQL, C#, .NET, Unity, PHP y Android Studio.', 'DONE', 'Escoles Universitàries Gimbernat Formació'),
    ...
    ('1', 'YourPath BackEnd Developer', ' oct 2020', 'Today', 'Cofundador de YourPath.Inc. BackEnd Developer y Tester', 'DOING', 'Fundacio Esplai'),
    
    -- Puntos Ismael
    ('2', 'CFGS Programación Multiplataforma Orientada al Ocio Digital y al Desarrollo de Videojuegos', 'sept 2020', 'jun 2021', 'Desarrollo de aplicaciones en lenguaje Java, SQL, C#, .NET, Unity, PHP y Android Studio.', 'DONE', 'ITB'),
    ('2', 'Monitor', 'jul 2022', 'ago 2022', 'Cuidar, entretener y educar al grupo de jovenes a mi cargo.', 'DONE', 'Fundació Pere Tarrés'),
    ('2', 'Actor', 'ene 2020', 'actualidad', 'Cofundador de Terratreros Terrassa. Dirección de escenario, Actuación, Guionaje, Diseño de Atretzzo', 'DOING', 'Terratreros Terrassa'),
	...
	('2', 'YourPath FullStack Developer', ' oct 2020', 'Today', 'Cofundador de YourPath.Inc. FullStack Developer y Team Leader', 'DOING', 'Fundación Esplai'),
    
    -- Puntos Roger
        ('3', 'Bachillerato Tecnológico con Selectividad Aprobada', 'sept 2015', 'jun 2017', 'Realicé el Bachillerato en la Escola Tecnos de Terrassa donde cursé las optativas de Física, Matemáticas Científicas, Diseño Gráfico y Tecnología Industrial.', 'DONE', 'Escola Tecnos/Institut Montserrat Roig'),
		...
		- Manejo de bases de datos SQL (MySQL).
		- Programación con Java SE y creación de API REST con Spring Boot.', 'DOING', 'Fundación Esplai'),
        ('3', 'YourPath Frontend Developer', ' oct 2020', 'Today', 'Cofundador de YourPath.Inc. FrontEnd Developer y QA', 'DOING', 'Fundación Esplai'),
...
- Manejo de bases de datos SQL (MySQL).
- Programación con Java SE y creación de API REST con Spring Boot.', 'DOING', 'Fundación Esplai'),
		('4', 'YourPath Frontend Developer', ' oct 2020', 'Today', 'Cofundador de YourPath.Inc. BackEnd Developer y Designer', 'DOING', 'Fundación Esplai');